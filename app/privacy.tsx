    ...
    >
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.body}>
          ...
          data. All data you create or enter in the App, including communication
          boards, symbols, settings, and user profiles, is stored locally on
          your device only. We do not transmit any data to external servers or
          third parties. We have no access to the content you create or the way
          you use the App.
        </Text>
        <Text style={styles.header}>Third party services</Text>
        <Text style={styles.body}>
          This App does not use any third-party services that may collect
          information used to identify you. We do not use analytics tools,
          tracking technologies, advertising networks, or crash reporting
          services.
        </Text>
        <Text style={styles.header}>Cookies and tracking</Text>
        <Text style={styles.body}>
          We do not use cookies, tracking pixels, or any other tracking
          technologies to monitor your activity or collect information about
          you.
        </Text>
        ...
        <Text style={styles.body}>
          Even though we do not collect your data, you have the right to
          understand how the App handles your information. You maintain complete
          control over your data and can access, export, back up, and delete all
          data stored locally on your device through the App interface.
        </Text>
        ...
        <Text style={styles.body}>
          ...
          (UK GDPR) and other international privacy regulations. Given our
          privacy-by-design approach of not collecting any user data, we
          maintain compliance by not processing personal data.
        </Text>
        ...
        <Text style={styles.body}>
          ...
          policy, please contact support@free-aac.org.
        </Text>
      </View>
    </ScrollView>
  )
